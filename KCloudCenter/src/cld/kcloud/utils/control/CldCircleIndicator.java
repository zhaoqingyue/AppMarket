...
@SuppressLint("NewApi") 
public class CldCircleIndicator extends LinearLayout {
    ...
    public CldCircleIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public CldCircleIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CldCircleIndicator);
        mIndicatorWidth =
                typedArray.getDimensionPixelSize(R.styleable.CldCircleIndicator_ci_width, -1);
        mIndicatorHeight =
                typedArray.getDimensionPixelSize(R.styleable.CldCircleIndicator_ci_height, -1);
        mIndicatorMargin =
                typedArray.getDimensionPixelSize(R.styleable.CldCircleIndicator_ci_margin, -1);

        mAnimatorResId = typedArray.getResourceId(R.styleable.CldCircleIndicator_ci_animator,
                R.animator.scale_with_alpha);
        mAnimatorReverseResId =
                typedArray.getResourceId(R.styleable.CldCircleIndicator_ci_animator_reverse, 0);
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CldCircleIndicator_ci_drawable,
                        R.drawable.white_radius);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.CldCircleIndicator_ci_drawable_unselected,
                        mIndicatorBackgroundResId);
        typedArray.recycle();
    }
