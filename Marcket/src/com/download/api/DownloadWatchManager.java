...
public class DownloadWatchManager 
{
	...
	List<MyWatchManager> mList = new ArrayList<DownloadWatchManager.
			MyWatchManager>(8);
	...
	{
		String mUrl = "";
		long mTempLength = 0, mDownLength = 0, mFileLength = 0;
		int mStatus = TaskStatus.DOWNLOAD_STATUS_IDLE;
		List<TaskStatus.ITaskCallBack> callbacks = 
				new ArrayList<TaskStatus.ITaskCallBack>();
